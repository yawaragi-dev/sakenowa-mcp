...
> **Status:** v0.1.0 — **released on [npm](https://www.npmjs.com/package/@yawaragi/sakenowa-mcp)** (`npm i @yawaragi/sakenowa-mcp`). Six read-only tools, served over **stdio** (default) or **Streamable HTTP** (`MCP_TRANSPORT=http`). See [`CHANGELOG.md`](./CHANGELOG.md) for release notes and [`docs/specs/v0.1.0.md`](./docs/specs/v0.1.0.md) for the full contract.
